...
Listbox.ɵfac = function Listbox_Factory(t) { return new (t || Listbox)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(ChangeDetectorRef)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Listbox, [{
  ...
  `,
    ...
    }], function () { return [{ type: ElementRef }, { type: ChangeDetectorRef }]; }, { checkbox: [{
            type: Input
        }], filter: [{
            type: Input
        }], filterMode: [{
